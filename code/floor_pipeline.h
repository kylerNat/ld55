void create_floor_pipeline(pipeline_info* pipeline)
{
    int error;
    ...
    //pipeline
    VkShaderModule vert_shader = create_shader_module_from_file("data/shaders/floor_vert.spv");
    VkShaderModule frag_shader = create_shader_module_from_file("data/shaders/floor_frag.spv");
...
pipeline_info* floor_pipeline = add_pipeline(create_floor_pipeline);
...
void draw_floor()
{
    ...
    vkCmdBindPipeline(vkon.command_buffers[f], VK_PIPELINE_BIND_POINT_GRAPHICS, floor_pipeline->pipeline);
