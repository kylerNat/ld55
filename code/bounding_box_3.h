#ifndef BOUNDING_BOX_3
#define BOUNDING_BOX_3
...
bool operator==(bounding_box_3 a, bounding_box_3 b)
{
    return (a.l==b.l && a.u==b.u);
}

bool is_inside(int_3 p, bounding_box_3 b)
{
...
bool is_intersecting(bounding_box_3 a, bounding_box_3 b)
{
...
bounding_box_3 expand_to(bounding_box_3 b, int_3 p)
{
...
int_3 dim(bounding_box_3 b)
{
    return b.u-b.l;
}

#endif //BOUNDING_BOX_3
